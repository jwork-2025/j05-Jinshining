...
相关的实现见作业3的仓库的最新commit：https://github.com/jwork-2025/j03-Jinshining/commit/6265140b03d09e30e88aa99b941ecf060d43588b
  - 实现了record功能和菜单界面，会在开始游戏时自动生成json文件
  - 实现了replay功能，可以选择查看任何一个回放文件，且在左上角显示回放进度，自动循环播放。现在有一点小瑕疵：回放时简化自身为圆形（而不是葫芦），回放的子弹在发射位置会滞留一帧，等之后看看能不能完善一下~